...
type LoadParameterValuesResponse struct {
	...
	MinGenerationTime *timestamp.Timestamp `protobuf:"bytes,2,opt,name=minGenerationTime" json:"minGenerationTime,omitempty"`
	// The latest generation time of all received values
	MaxGenerationTime *timestamp.Timestamp `protobuf:"bytes,3,opt,name=maxGenerationTime" json:"maxGenerationTime,omitempty"`
}
...
func (x *LoadParameterValuesResponse) GetMinGenerationTime() *timestamp.Timestamp {
	if x != nil {
...
func (x *LoadParameterValuesResponse) GetMaxGenerationTime() *timestamp.Timestamp {
	if x != nil {
...
func (x *ParameterValueUpdate) GetGenerationTime() *timestamp.Timestamp {
	if x != nil {
...
var file_yamcs_protobuf_pvalue_pvalue_service_proto_rawDesc = []byte{
	...
	0x72, 0x61, 0x6d, 0x65, 0x74, 0x65, 0x72, 0x56, 0x61, 0x6c, 0x75, 0x65, 0x73, 0x52, 0x65, 0x73,
	0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x3f, 0x8a, 0x92, 0x03, 0x3b, 0x1a, 0x36, 0x2f, 0x61, 0x70,
	0x69, 0x2f, 0x70, 0x61, 0x72, 0x61, 0x6d, 0x65, 0x74, 0x65, 0x72, 0x2d, 0x76, 0x61, 0x6c, 0x75,
	0x65, 0x73, 0x2f, 0x7b, 0x69, 0x6e, 0x73, 0x74, 0x61, 0x6e, 0x63, 0x65, 0x7d, 0x2f, 0x73, 0x74,
	0x72, 0x65, 0x61, 0x6d, 0x73, 0x2f, 0x7b, 0x73, 0x74, 0x72, 0x65, 0x61, 0x6d, 0x7d, 0x3a, 0x6c,
	0x6f, 0x61, 0x64, 0x3a, 0x01, 0x2a, 0x28, 0x01, 0x42, 0x70, 0x0a, 0x12, 0x6f, 0x72, 0x67, 0x2e,
	...
	0x62, 0x75, 0x66, 0x2f, 0x70, 0x76, 0x61, 0x6c, 0x75, 0x65,
}

var (
	file_yamcs_protobuf_pvalue_pvalue_service_proto_rawDescOnce sync.Once
	file_yamcs_protobuf_pvalue_pvalue_service_proto_rawDescData = file_yamcs_protobuf_pvalue_pvalue_service_proto_rawDesc
)
...
func file_yamcs_protobuf_pvalue_pvalue_service_proto_rawDescGZIP() []byte {
	file_yamcs_protobuf_pvalue_pvalue_service_proto_rawDescOnce.Do(func() {
		file_yamcs_protobuf_pvalue_pvalue_service_proto_rawDescData = protoimpl.X.CompressGZIP(file_yamcs_protobuf_pvalue_pvalue_service_proto_rawDescData)
	})
...
var file_yamcs_protobuf_pvalue_pvalue_service_proto_goTypes = []interface{}{
...
func file_yamcs_protobuf_pvalue_pvalue_service_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_yamcs_protobuf_pvalue_pvalue_service_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*LoadParameterValuesRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_yamcs_protobuf_pvalue_pvalue_service_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*LoadParameterValuesResponse); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_yamcs_protobuf_pvalue_pvalue_service_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*ParameterValueUpdate); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_yamcs_protobuf_pvalue_pvalue_service_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   3,
			NumExtensions: 0,
			NumServices:   1,
	...
	file_yamcs_protobuf_pvalue_pvalue_service_proto_rawDesc = nil
