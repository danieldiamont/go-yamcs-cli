...
type YamcsInstance struct {
	...
	MissionTime  *timestamp.Timestamp `protobuf:"bytes,10,opt,name=missionTime" json:"missionTime,omitempty"`
...
func (x *YamcsInstance) GetMissionTime() *timestamp.Timestamp {
	if x != nil {
...
var file_yamcs_protobuf_instances_instances_proto_rawDesc = []byte{
	...
	0x07, 0x20, 0x01, 0x28, 0x09, 0x52, 0x07, 0x69, 0x6e, 0x69, 0x74, 0x69, 0x61, 0x6c, 0x42, 0x66,
	...
	0x6f, 0x6d, 0x2f, 0x64, 0x61, 0x6e, 0x69, 0x65, 0x6c, 0x64, 0x69, 0x61, 0x6d, 0x6f, 0x6e, 0x74,
	0x2f, 0x67, 0x6f, 0x2d, 0x79, 0x61, 0x6d, 0x63, 0x73, 0x2d, 0x63, 0x6c, 0x69, 0x2f, 0x79, 0x61,
	0x6d, 0x63, 0x73, 0x2f, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x62, 0x75, 0x66, 0x2f, 0x69, 0x6e, 0x73,
	0x74, 0x61, 0x6e, 0x63, 0x65, 0x73,
}

var (
	file_yamcs_protobuf_instances_instances_proto_rawDescOnce sync.Once
	file_yamcs_protobuf_instances_instances_proto_rawDescData = file_yamcs_protobuf_instances_instances_proto_rawDesc
)
...
func file_yamcs_protobuf_instances_instances_proto_rawDescGZIP() []byte {
	file_yamcs_protobuf_instances_instances_proto_rawDescOnce.Do(func() {
		file_yamcs_protobuf_instances_instances_proto_rawDescData = protoimpl.X.CompressGZIP(file_yamcs_protobuf_instances_instances_proto_rawDescData)
	})
...
var file_yamcs_protobuf_instances_instances_proto_goTypes = []interface{}{
...
func file_yamcs_protobuf_instances_instances_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_yamcs_protobuf_instances_instances_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*YamcsInstance); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_yamcs_protobuf_instances_instances_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		file_yamcs_protobuf_instances_instances_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_yamcs_protobuf_instances_instances_proto_rawDesc,
			NumEnums:      1,
			NumMessages:   5,
			NumExtensions: 0,
			NumServices:   0,
	...
	file_yamcs_protobuf_instances_instances_proto_rawDesc = nil
