...
func (x *ListAuditRecordsRequest) GetStart() *timestamp.Timestamp {
	if x != nil {
		return x.Start
	}
	return nil
...
func (x *ListAuditRecordsRequest) GetStop() *timestamp.Timestamp {
	if x != nil {
		return x.Stop
	}
	return nil
...
var file_yamcs_protobuf_audit_audit_proto_rawDesc = []byte{
	...
	0x7d, 0x42, 0x6b, 0x0a, 0x18, 0x6f, 0x72, 0x67, 0x2e, 0x79, 0x61, 0x6d, 0x63, 0x73, 0x2e, 0x70,
	...
	0x50, 0x01, 0x5a, 0x3a, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e, 0x63, 0x6f, 0x6d, 0x2f, 0x64,
	...
	0x70, 0x72, 0x6f, 0x74, 0x6f, 0x62, 0x75, 0x66, 0x2f, 0x61, 0x75, 0x64, 0x69, 0x74,
}

var (
	file_yamcs_protobuf_audit_audit_proto_rawDescOnce sync.Once
	file_yamcs_protobuf_audit_audit_proto_rawDescData = file_yamcs_protobuf_audit_audit_proto_rawDesc
)

func file_yamcs_protobuf_audit_audit_proto_rawDescGZIP() []byte {
	file_yamcs_protobuf_audit_audit_proto_rawDescOnce.Do(func() {
		file_yamcs_protobuf_audit_audit_proto_rawDescData = protoimpl.X.CompressGZIP(file_yamcs_protobuf_audit_audit_proto_rawDescData)
	})
...
var file_yamcs_protobuf_audit_audit_proto_goTypes = []interface{}{
...
func file_yamcs_protobuf_audit_audit_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_yamcs_protobuf_audit_audit_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_yamcs_protobuf_audit_audit_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		file_yamcs_protobuf_audit_audit_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_yamcs_protobuf_audit_audit_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   3,
			NumExtensions: 0,
			NumServices:   1,
	...
	file_yamcs_protobuf_audit_audit_proto_rawDesc = nil
