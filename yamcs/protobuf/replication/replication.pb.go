...
var file_yamcs_protobuf_replication_replication_proto_rawDesc = []byte{
	...
	0x01, 0x42, 0x6a, 0x0a, 0x12, 0x6f, 0x72, 0x67, 0x2e, 0x79, 0x61, 0x6d, 0x63, 0x73, 0x2e, 0x70,
	...
	0x66, 0x2f, 0x72, 0x65, 0x70, 0x6c, 0x69, 0x63, 0x61, 0x74, 0x69, 0x6f, 0x6e,
}

var (
	file_yamcs_protobuf_replication_replication_proto_rawDescOnce sync.Once
	file_yamcs_protobuf_replication_replication_proto_rawDescData = file_yamcs_protobuf_replication_replication_proto_rawDesc
)
...
func file_yamcs_protobuf_replication_replication_proto_rawDescGZIP() []byte {
	file_yamcs_protobuf_replication_replication_proto_rawDescOnce.Do(func() {
		file_yamcs_protobuf_replication_replication_proto_rawDescData = protoimpl.X.CompressGZIP(file_yamcs_protobuf_replication_replication_proto_rawDescData)
	})
...
var file_yamcs_protobuf_replication_replication_proto_goTypes = []interface{}{
...
func file_yamcs_protobuf_replication_replication_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_yamcs_protobuf_replication_replication_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_yamcs_protobuf_replication_replication_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*ReplicationMasterInfo); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_yamcs_protobuf_replication_replication_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*ReplicationSlaveInfo); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_yamcs_protobuf_replication_replication_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   3,
			NumExtensions: 0,
			NumServices:   1,
	...
	file_yamcs_protobuf_replication_replication_proto_rawDesc = nil
