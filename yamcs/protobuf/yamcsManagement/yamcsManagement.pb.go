...
import (
	...
	services "github.com/danieldiamont/go-yamcs-cli/yamcs/protobuf/services"
...
type ProcessorInfo struct {
	...
	Time                  *timestamp.Timestamp               `protobuf:"bytes,18,opt,name=time" json:"time,omitempty"`
...
func (x *ProcessorInfo) GetTime() *timestamp.Timestamp {
	if x != nil {
		return x.Time
	}
	return nil
...
type TmStatistics struct {
	...
	LastReceived             *timestamp.Timestamp `protobuf:"bytes,10,opt,name=lastReceived" json:"lastReceived,omitempty"`
	LastPacketTime           *timestamp.Timestamp `protobuf:"bytes,11,opt,name=lastPacketTime" json:"lastPacketTime,omitempty"`
...
func (x *TmStatistics) GetLastReceived() *timestamp.Timestamp {
	if x != nil {
...
func (x *TmStatistics) GetLastPacketTime() *timestamp.Timestamp {
	if x != nil {
...
type Statistics struct {
	...
	LastUpdated *timestamp.Timestamp `protobuf:"bytes,6,opt,name=lastUpdated" json:"lastUpdated,omitempty"` //java local time of the last update
}
...
func (x *Statistics) GetLastUpdated() *timestamp.Timestamp {
	if x != nil {
...
var file_yamcs_protobuf_yamcsManagement_yamcsManagement_proto_rawDesc = []byte{
	...
	0x44, 0x10, 0x03, 0x42, 0x72, 0x0a, 0x12, 0x6f, 0x72, 0x67, 0x2e, 0x79, 0x61, 0x6d, 0x63, 0x73,
	...
	0x01, 0x5a, 0x44, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e, 0x63, 0x6f, 0x6d, 0x2f, 0x64, 0x61,
	...
	0x72, 0x6f, 0x74, 0x6f, 0x62, 0x75, 0x66, 0x2f, 0x79, 0x61, 0x6d, 0x63, 0x73, 0x4d, 0x61, 0x6e,
	0x61, 0x67, 0x65, 0x6d, 0x65, 0x6e, 0x74,
}

var (
	file_yamcs_protobuf_yamcsManagement_yamcsManagement_proto_rawDescOnce sync.Once
	file_yamcs_protobuf_yamcsManagement_yamcsManagement_proto_rawDescData = file_yamcs_protobuf_yamcsManagement_yamcsManagement_proto_rawDesc
)
...
func file_yamcs_protobuf_yamcsManagement_yamcsManagement_proto_rawDescGZIP() []byte {
	file_yamcs_protobuf_yamcsManagement_yamcsManagement_proto_rawDescOnce.Do(func() {
		file_yamcs_protobuf_yamcsManagement_yamcsManagement_proto_rawDescData = protoimpl.X.CompressGZIP(file_yamcs_protobuf_yamcsManagement_yamcsManagement_proto_rawDescData)
	})
...
var file_yamcs_protobuf_yamcsManagement_yamcsManagement_proto_goTypes = []interface{}{
...
func file_yamcs_protobuf_yamcsManagement_yamcsManagement_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_yamcs_protobuf_yamcsManagement_yamcsManagement_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_yamcs_protobuf_yamcsManagement_yamcsManagement_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*AcknowledgmentInfo); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_yamcs_protobuf_yamcsManagement_yamcsManagement_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*TmStatistics); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_yamcs_protobuf_yamcsManagement_yamcsManagement_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
		...
		file_yamcs_protobuf_yamcsManagement_yamcsManagement_proto_msgTypes[4].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*ProcessorManagementRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_yamcs_protobuf_yamcsManagement_yamcsManagement_proto_msgTypes[5].Exporter = func(v interface{}, i int) interface{} {
		...
		file_yamcs_protobuf_yamcsManagement_yamcsManagement_proto_msgTypes[6].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_yamcs_protobuf_yamcsManagement_yamcsManagement_proto_rawDesc,
			NumEnums:      3,
			NumMessages:   7,
			NumExtensions: 0,
			NumServices:   0,
	...
	file_yamcs_protobuf_yamcsManagement_yamcsManagement_proto_rawDesc = nil
