...
var file_yamcs_api_websocket_proto_rawDesc = []byte{
	...
	0x42, 0x57, 0x0a, 0x12, 0x6f, 0x72, 0x67, 0x2e, 0x79, 0x61, 0x6d, 0x63, 0x73, 0x2e, 0x70, 0x72,
	...
	0x79, 0x61, 0x6d, 0x63, 0x73, 0x2f, 0x61, 0x70, 0x69, 0x62, 0x06, 0x70, 0x72, 0x6f, 0x74, 0x6f,
	0x33,
}

var (
	file_yamcs_api_websocket_proto_rawDescOnce sync.Once
	file_yamcs_api_websocket_proto_rawDescData = file_yamcs_api_websocket_proto_rawDesc
)

func file_yamcs_api_websocket_proto_rawDescGZIP() []byte {
	file_yamcs_api_websocket_proto_rawDescOnce.Do(func() {
		file_yamcs_api_websocket_proto_rawDescData = protoimpl.X.CompressGZIP(file_yamcs_api_websocket_proto_rawDescData)
	})
...
var file_yamcs_api_websocket_proto_goTypes = []interface{}{
...
func file_yamcs_api_websocket_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_yamcs_api_websocket_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_yamcs_api_websocket_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		file_yamcs_api_websocket_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
		...
		file_yamcs_api_websocket_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*Reply); i {
			case 0:
				return &v.state
			case 1:
		...
		file_yamcs_api_websocket_proto_msgTypes[4].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*State); i {
			case 0:
				return &v.state
			case 1:
		...
		file_yamcs_api_websocket_proto_msgTypes[5].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*State_CallInfo); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_yamcs_api_websocket_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   6,
			NumExtensions: 0,
			NumServices:   0,
	...
	file_yamcs_api_websocket_proto_rawDesc = nil
